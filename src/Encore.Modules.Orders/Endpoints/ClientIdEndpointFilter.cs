...
/// authentication. Copied from Inventory rather than shared: <c>Encore.Shared</c> must stay
/// free of ASP.NET Core. Its item key differs so two filters on one route cannot collide.
/// </summary>
