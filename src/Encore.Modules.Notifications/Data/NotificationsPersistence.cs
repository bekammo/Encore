...
/// <summary>
/// The one place that says how a <see cref="NotificationsDbContext"/> is wired to Postgres.
/// </summary>
/// <remarks>
/// <para>
...
/// Notifications' own: the schema name and the vocabulary its callers use. The schema
